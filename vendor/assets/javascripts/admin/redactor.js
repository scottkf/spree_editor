...
*/
    ...
    {
      this.s3executeOnSignedUrl(file, $.proxy(function(response)
      {
        data = $.parseJSON(response);
        this.s3uploadToS3(file, data.url, data.content_type);
      }, this));
    },
    s3executeOnSignedUrl: function(file, callback)
    {
      var xhr = new XMLHttpRequest();
      xhr.open('GET', this.opts.s3 + '?name=' + file.name.replace(/ /g,"_") + '&type=' + file.type, true);
    ...
    s3uploadToS3: function(file, url, content_type)
    {
